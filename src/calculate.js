...
function calculatePayment() {
  ...
  console.log("docomo 1, 2");
  console.log(oneYearPaymentDocomo);
  console.log(twoYearPaymentDocomo);
  console.log("sim 1, 2")
  console.log(oneYearPaymentSim);
  console.log(twoYearPaymentSim);
  console.log(buy);
  console.log(docomoDescription);
  console.log(simDescription)
